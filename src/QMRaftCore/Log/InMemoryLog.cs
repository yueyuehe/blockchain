...
namespace QMRaftCore.Log
{
    public class InMemoryLog : ILog
    {
        ...
        public Task<LogEntry> GetLastLogEntry()
        {
        ...
        public Task<LogEntry> GetLogEntry(long height)
        {
            throw new NotImplementedException();
        }

        public Task<Dictionary<long, LogEntry>> GetLogEntrys(long[] heights)
        {
            throw new NotImplementedException();
        }

        public Task<bool> SaveLogEntrys(LogEntry log)
        {
            throw new NotImplementedException();
        }
    }
